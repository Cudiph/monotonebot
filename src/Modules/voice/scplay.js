...
module.exports = class PlayCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      group: 'voice',
      memberName: 'scplay',
      aliases: ['scp', 'soundcloudplay'],
      description: 'Same as play but the search query is provided by soundcloud',
      examples: ['scplay FusionNFire', 'scp https://soundcloud.com/pika5onic/starlight-featrakey'],
      argsType: 'multiple',
      guildOnly: true,
      throttling: {
        usages: 2,
      ...
      args: [
        {
          key: 'queryOrUrl',
          prompt: 'What video you want to search or put a videoID/url?',
          type: 'string',
        }
      ]
    });
  ...
  async run(msg, { queryOrUrl }) {
    ...
    let res;
    try {
      res = await node.rest.resolve(queryOrUrl, 'soundcloud');
